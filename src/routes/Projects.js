...
function Projects() {
	return (
		<div className="PageContent">
			...
			<div className="divBlock">
				<div className="halfBlock">
					<p>My first Python project was Data Sora. I was determined to solve a challenge in the Kingdom Hearts Union χ community. There were two issues. First, the in-game notice list was only available in the in-game browser, and many browser feature were disabled. Second, the notice list only displayed the 20 most recent notices. With my Data Sora project, I created a solution for both challenges.</p>
