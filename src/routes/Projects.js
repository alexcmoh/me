		...
		<div className="PageContent">
			...
			<div className="divBlock">
				<div className="halfBlock">
                    ...
                    <p>This led to the creation of the KHUX Info Page, a website with multiple pages to disperse data to the community. The first challenge I solved was allowing users to effectively plan their equipment upgrades, which uses a limited resource. I created a cost calculator page that showed users the material cost required and stat growth gained from a start level to an end level. Since the cost calculator's release, the site has expanded to include tools for searching, sorting, and filtering over the 2,000 characters that the game features. This unit search tool harnessed JavaScript and HTML to allow users to perform operations over the dataset and view outputted characters in concise info cards.</p>
